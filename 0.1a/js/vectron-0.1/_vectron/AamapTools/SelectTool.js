...
SelectTool.prototype = {
    ...
    */
    ...
    selectArea:function( xStart, yStart, xEnd, yEnd ) {
        ...
        this.vectron.gui.writeLog(this.selectedObjs.length);
    },
    ...
    deleteObjs:function() {
        this.vectron.gui.writeLog(this.selectedObjs);
        if(this.selectedObjs.length <= 0) {
            this.vectron.gui.writeLog("No objects to delete.");
            return;
        } else {
            this.vectron.map.deleteObjs(this.selectedObjs);
            this.selectedObjs = [];
            this.deselectAll();
        }
    },
