...
(function(factory){
  ...
  Backbone.Mediator = {
    ...
    publish: function(channel) {
      ...
      /*
      bugfix http://stackoverflow.com/questions/12245468/backbone-requirejs-mediator-pattern-resulted-in-view-logic-short-circuiting
      original:
  ...
  // HACK: return mediator directly for quicker coding
  return Backbone.Mediator;
